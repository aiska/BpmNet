...
namespace BPMNET.Condition.Parsing
{
    ...
    internal class ExpressionTokenizer : Tokenizer
    {
        ...
        private void CreatePatterns()
        {
            ...
            pattern = new TokenPattern(Convert.ToInt32(ExpressionConstants.AND), "AND", TokenPattern.PatternType.STRING, "&&");
            AddPattern(pattern);

            pattern = new TokenPattern(Convert.ToInt32(ExpressionConstants.OR), "OR", TokenPattern.PatternType.STRING, "||");
            AddPattern(pattern);

            pattern = new TokenPattern(Convert.ToInt32(ExpressionConstants.XOR), "XOR", TokenPattern.PatternType.STRING, "^");
            AddPattern(pattern);

            pattern = new TokenPattern(Convert.ToInt32(ExpressionConstants.NOT), "NOT", TokenPattern.PatternType.STRING, "!");
            AddPattern(pattern);
