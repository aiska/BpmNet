...
using BPMNET.Condition.ExpressionElements;
...
using BPMNET.Condition.ExpressionElements.LogicalBitwise;
using BPMNET.Condition.ExpressionElements.MemberElements;
