...
using BPMNET.Condition.CalcEngine.InternalTypes;
using BPMNET.Condition.CalcEngine.PublicTypes;
...
namespace BPMNET.Condition.PublicTypes
{
    public sealed class ExpressionContext
    {
        ...
        {
            return new InternalTypes.Expression<object>(expression, this, false);
        }

        public IGenericExpression<TResultType> CompileGeneric<TResultType>(string expression)
        {
            return new InternalTypes.Expression<TResultType>(expression, this, true);
        }
