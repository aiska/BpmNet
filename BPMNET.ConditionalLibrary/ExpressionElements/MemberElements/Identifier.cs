...
using BPMNET.Condition.ExpressionElements.Literals.Integral;
using BPMNET.Condition.ExpressionElements.Literals.Real;
using BPMNET.Condition.InternalTypes;
using BPMNET.Condition.PublicTypes;
using BPMNET.Condition.Resources;


namespace BPMNET.Condition.ExpressionElements.MemberElements
{
